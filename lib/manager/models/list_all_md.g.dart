...
ListTaxes _$ListTaxesFromJson(Map<String, dynamic> json) => ListTaxes(
      id: json['id'] as int,
      active: json['active'] as bool,
...
ListPaymentMethods _$ListPaymentMethodsFromJson(Map<String, dynamic> json) =>
    ListPaymentMethods(
      id: json['id'] as int,
      name: json['name'] as String,
      active: json['active'] as bool,
...
Map<String, dynamic> _$ListPaymentMethodsToJson(ListPaymentMethods instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'active': instance.active,
