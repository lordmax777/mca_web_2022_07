...
class ClientForm extends StatefulWidget {
  ...
  const ClientForm({Key? key, required this.state}) : super(key: key);
          ...
          child: SpacedColumn(verticalSpace: 16, children: [
            ...
            labelWithField(
              ...
              DropdownWidgetV2(
                ...
                value: CustomDropdownValue(
                    name: currencies
                        .firstWhereOrNull((element) => element.id == currencyId)
                        ?.sign),
                onChanged: (index) {
                  setState(() {
            ...
            labelWithField(
              ...
              TextInputWidget(
                width: 300,
                isRequired: true,
                controller: TextEditingController(text: payingDays?.toString()),
