...
class TeamPopup extends StatefulWidget {
  final TeamData data;
  final List<UserMd> unavailableUsers;

  const TeamPopup(
      {super.key, required this.data, required this.unavailableUsers});

  @override
  State<TeamPopup> createState() => _TeamPopupState();
}

class _TeamPopupState extends State<TeamPopup> {
  late final TeamData data;
              ...
              SizedBox(
                ...
                child: ListView.builder(
                    itemBuilder: (context, index) {
                      ...
                      final bool isAdded =
                          data.users.any((element) => element.id == user.id);
                      return ListTile(
