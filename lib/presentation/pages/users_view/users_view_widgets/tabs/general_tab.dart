            ...
            children: [
              ...
              UserCard(
                ...
                items: [
                          ...
                          data = data.copyWith(
                              personal: data.personal.copyWith(
                                  userTitle: titles.firstWhereOrNull(
                                      (element) =>
                                          element.code == value.additionalId)));
                        }),
                  ),
                  UserCardItem(
                      isRequired: true,
                  ...
                  UserCardItem(title: "Email", controller: data.personal.email),
                  UserCardItem(
                      title: "Phone Number",
                  ...
                  UserCardItem(
                    title: "Date of Birth",
                    simpleText: data.personal.dateOfBirth?.toApiDateWithDash ??
                        "Select Date",
                    onSimpleTextTapped: () {
                      showDatePicker(
                        context: context,
                  ...
                  UserCard(
                    ...
                    items: [
                            ...
                            onChanged: (value) {
                              data = data.copyWith(
                                  roleDepartmentLoginOptions:
                                      data.roleDepartmentLoginOptions.copyWith(
                      ...
                      UserCardItem(
                        ...
                        dropdown: UserCardDropdown(
                            valueId:
                                data.roleDepartmentLoginOptions.department?.id,
                            items: [
                        ...
                        dropdown: UserCardDropdown(
                            ...
                            onChanged: (value) {
                              data = data.copyWith(
                                  roleDepartmentLoginOptions:
                                      data.roleDepartmentLoginOptions.copyWith(
                                          location: locations.firstWhereOrNull(
                                              (element) =>
                                                  element.id == value.id)));
                            }),
                      ),
                      UserCardItem(
                        ...
                        dropdown: UserCardDropdown(
                            additionalValueId:
                                data.roleDepartmentLoginOptions.language?.code,
                            items: [
                      ...
                      if (data.roleDepartmentLoginOptions.role?.code ==
                        ...
                        UserCardItem(
                          ...
                          checked:
                              data.roleDepartmentLoginOptions.isLocationManager,
                          onChecked: (value) {
                            data = data.copyWith(
                                roleDepartmentLoginOptions: data
                                    .roleDepartmentLoginOptions
                                        ...
                                        onChanged: (value) {
                                          if (value) {
                                            data = data.copyWith(
                                              ...
                                              ...data.roleDepartmentLoginOptions
                                                  .loginMethods,
                                              loginMethod
                                            ]));
                                          } else {
